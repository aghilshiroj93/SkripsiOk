    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-2">
                ...
                <a href="{{ route('rekapabsensi.export.excel', request()->query()) }}"
                ...
                <a href="{{ route('rekapabsensi.export.pdf', request()->query()) }}"
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($rekap as $item)
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $item['jurusan'] }}
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-center text-sm font-semibold text-red-500">
                                        {{ $item['alpa'] }}</td>
                                    <td class="px-6 py-4 text-center text-sm font-bold text-gray-900">{{ $item['total'] }}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        @else
            <div class="bg-white rounded-xl shadow-md p-8 text-center">
                ...
                <p class="mt-1 text-sm text-gray-500">Silakan gunakan filter di atas untuk menampilkan data rekapitulasi
                    absensi.</p>
            </div>
        @endif
    </div>
