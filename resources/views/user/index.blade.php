...
@section('content')
    <div class="max-w-6xl mx-auto py-6 px-4">
                    ...
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td class="px-4 py-2 space-x-2">
                                ...
                                <form id="deleteForm{{ $user->id }}" action="{{ route('user.destroy', $user->id) }}"
        ...
        <div id="tambahUserModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
            <div class="bg-white rounded-lg p-6 w-full max-w-md">
                ...
                <form action="{{ route('user.store') }}" method="POST" id="tambahUserForm">
                    @csrf
                    <div class="mb-3">
                        <label class="block text-sm">Nama</label>
    ...
    <script>
        function openModal(id) {
            // Reset form ketika membuka modal tambah
            if (id === 'tambahUserModal') {
